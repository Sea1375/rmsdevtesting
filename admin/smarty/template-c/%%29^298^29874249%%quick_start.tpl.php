<?php /* Smarty version 2.6.31, created on 2021-05-02 06:16:14
         compiled from /home/rmsdevtesting/rmsdevtesting.com/admin/docs/english/quick_start.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape_admin_area', '/home/rmsdevtesting/rmsdevtesting.com/admin/docs/english/quick_start.tpl', 3015, false),)), $this); ?>
<div id="documentation">
	...
	<div>
		...
		<p class="code">
			...
			&lt;input type="text" name="username" maxlength="100" value="<?php echo ((is_array($_tmp='{{')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
$generated_username<?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
"/&gt;<br/>
			<br/>
			<span class="comment">&lt;!-- password input --&gt;</span><br/>
			&lt;input type="password" name="pass" value="<?php echo ((is_array($_tmp='{{')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
$generated_password<?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
"/&gt;<br/>
			<br/>
			<span class="comment">&lt;!-- password confirmation input --&gt;</span><br/>
			&lt;input type="password" name="pass2" value="<?php echo ((is_array($_tmp='{{')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
$generated_password<?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
"/&gt;<br/>
			<br/>
			<span class="comment">&lt;!-- email input --&gt;</span><br/>
			&lt;input type="text" name="email" maxlength="100" value="<?php echo ((is_array($_tmp='{{')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
$generated_email<?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
"/&gt;
		</p>
		<p>
...
if $smarty.session.status_id==3<?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
<br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<span class="comment">this is the premium user</span><br/>
			<?php echo ((is_array($_tmp='{{')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
elseif $smarty.session.user_id>0<?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
<br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<span class="comment">this is the non-premium user who has not logged in</span><br/>
			<?php echo ((is_array($_tmp='{{')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
else<?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
<br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<span class="comment">this is the user who hasn’t logged in</span><br/>
			<?php echo ((is_array($_tmp='{{')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
/if<?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
	...
	<div>
		...
		<p class="code">
			&lt;a href="https://secure.payment-processor.com/?reseller_code=<?php echo ((is_array($_tmp='{{')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
$smarty.request.<b>refid</b><?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
"&gt;Get premium access!&lt;/a&gt;
	...
	<div>
		...
		<p class="code">
			<?php echo ((is_array($_tmp='{{')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
$storage.video_view_video_view.title<?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>

		</p>
		<p>
			To iterate by an array variable, use <?php echo ((is_array($_tmp='{{')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
foreach<?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
:
		</p>
		<p class="code">
			<?php echo ((is_array($_tmp='{{')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
foreach name=data item=<b>item</b> from=$storage.video_view_video_view.tags<?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
<br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<span class="comment"><?php echo ((is_array($_tmp='{{')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
* Addressing an array element via the item variable *<?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
</span><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ((is_array($_tmp='{{')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
<b>$item</b>.tag_id<?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
<br/>
			&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ((is_array($_tmp='{{')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
<b>$item</b>.tag<?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
<br/>
			<?php echo ((is_array($_tmp='{{')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
/foreach<?php echo ((is_array($_tmp='}}')) ? $this->_run_mod_handler('escape_admin_area', true, $_tmp) : smarty_modifier_escape_admin_area($_tmp)); ?>
<br/>
