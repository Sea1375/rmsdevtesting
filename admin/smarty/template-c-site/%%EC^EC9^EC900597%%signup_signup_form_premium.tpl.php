...
">
									...
									<div class="modal__window__row">
										<label for="signup_country_id" class="modal__window__label required"><?php echo ((is_array($_tmp=$this->_tpl_vars['lang']['signup']['field_country_id'])) ? $this->_run_mod_handler('escape_ss', true, $_tmp) : smarty_modifier_escape_ss($_tmp)); ?>
 (*):</label>
...
">
									...
									<div class="row">
										<label for="signup_custom1" class="modal__window__label required"><?php echo ((is_array($_tmp=$this->_tpl_vars['lang']['signup']['field_charity_id'])) ? $this->_run_mod_handler('escape_ss', true, $_tmp) : smarty_modifier_escape_ss($_tmp)); ?>
 (*):</label>
										<div class="relative">
...
"/>
						...
						<div class="right">
							<ul class="profits__list">
								<?php $_from = ((is_array($_tmp=$this->_tpl_vars['lang']['memberzone']['access_packages']['profits'])) ? $this->_run_mod_handler('escape_ss', true, $_tmp) : smarty_modifier_escape_ss($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
