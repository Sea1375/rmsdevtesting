...
>
				...
				<?php if (((is_array($_tmp=$this->_tpl_vars['list_videos_show_sorting'])) ? $this->_run_mod_handler('escape_ss', true, $_tmp) : smarty_modifier_escape_ss($_tmp)) == 'true'): ?>
					<?php if (count ( ((is_array($_tmp=$this->_tpl_vars['data'])) ? $this->_run_mod_handler('escape_ss', true, $_tmp) : smarty_modifier_escape_ss($_tmp)) ) > 0 || ((is_array($_tmp=((is_array($_tmp=$_GET['countryId'])) ? $this->_run_mod_handler('escape_ss', true, $_tmp) : smarty_modifier_escape_ss($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0)) > 0): ?>
...
?>
															<?php if (((is_array($_tmp=$this->_tpl_vars['sort_by'])) ? $this->_run_mod_handler('escape_ss', true, $_tmp) : smarty_modifier_escape_ss($_tmp)) != ((is_array($_tmp=$this->_tpl_vars['item2'])) ? $this->_run_mod_handler('escape_ss', true, $_tmp) : smarty_modifier_escape_ss($_tmp))): ?>
																<li>
																	<a class="js-filters" href="<?php echo ((is_array($_tmp=$this->_tpl_vars['base_url'])) ? $this->_run_mod_handler('escape_ss', true, $_tmp) : smarty_modifier_escape_ss($_tmp)); ?>
...
" class="btn js-filters"><?php echo ((is_array($_tmp=$this->_tpl_vars['lang']['videos']['list_switch_favourites'][$this->_tpl_vars['item']])) ? $this->_run_mod_handler('escape_ss', true, $_tmp) : smarty_modifier_escape_ss($_tmp)); ?>
...
/"<?php endif; ?> width="390" height="320"/>
							<div class="thumb__info">
								<div class="thumb-spot">
									...
									<div class="thumb-spot__rating rotated"><span><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['user_rating'])) ? $this->_run_mod_handler('escape_ss', true, $_tmp) : smarty_modifier_escape_ss($_tmp)); ?>
</span></div>
									<div class="thumb-spot__rating rotated red"><span><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['rating'])) ? $this->_run_mod_handler('escape_ss', true, $_tmp) : smarty_modifier_escape_ss($_tmp)))) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.1f") : smarty_modifier_string_format($_tmp, "%.1f")); ?>
</span></div>
